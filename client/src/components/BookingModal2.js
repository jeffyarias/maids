...
<form onSubmit={this.submitHandler}>
    <div className={classes.section}><span>1</span>First Name &amp; Address</div>
    ...
    <div className={classes.section}><span>2</span>Email &amp; Phone</div>
    <div className={classes.innerwrap}>
    ...
    <div className={classes.section}><span>3</span>Passwords</div>
        <div className={classes.innerwrap}>
